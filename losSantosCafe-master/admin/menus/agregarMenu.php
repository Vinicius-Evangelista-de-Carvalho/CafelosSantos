...
<html>
	<head>
        ...
        <script src="../../js/json/obtenerTipoBebidas.js"></script>
	</head>
    <body>
    	<div class="section">
            <div class="container">
                <div class="row" id="titulo">
                    ...
                    <p id="subheader">Panel de Administración de los menús</p>                   
                </div>
                <div class="row">
                    <div class="col-md-2">                        
                    </div>
                    <div class="col-md-8 panel panel-default" id="panel">
                        <div class="panel-body">
                            ...
                            <form action="../uploadMenu.php" method="post" enctype="multipart/form-data">
                                ...
                                <div>
                                    <label class="control-label" id="label">Ingrese un nombre para la bebida:</label>  
                                    <input type="text" class="form-control" name="nombre" id="nombre" required>
                                </div>
                                <div>
                                	<label class="control-label" id="label">Seleccione el menú donde desea guardar la imagen:</label>  
                                    
                                    <select class="form-control" name="tipoBebida" id="tipoBebidas" >
                                        
                                    </select>
                                </div>
                                <div>                                	
                                	<label class="control-label" id="label">Ingrese una descripción de la bebida:</label>
	                        		<textarea class="form-control resizable" rows="3" name="ingredientes" id="ingredientes" maxlength="100" required></textarea>
	                            	<div id"contador"></div>
                                </div>
                                </br>
